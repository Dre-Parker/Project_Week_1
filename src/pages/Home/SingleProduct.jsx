...
const demoText = {
  description:
    'Bring your favorite anime world to life with this [Product Name]! Perfect for fans of [Anime Name] or lovers of vibrant Japanese animation, this [type of product: figure, clothing, accessory, etc.] showcases incredible attention to detail and captures the essence of the series. Whether youre looking to display it proudly in your collection, wear it to show off your fandom, or use it in your everyday life, this product is a must-have for anime enthusiasts',
  highlights: [
