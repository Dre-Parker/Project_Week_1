...
const Navbar = () => {
  ...
  const navItems = [
    { title: "Anime Hoodies & Clothing", path: "/" },
    { title: "Anime Badges", path: "/" },
    { title: "Katana", path: "/" },
    { title: "Comics & Manga", path: "/" },
    { title: "Posters", path: "/" },
    { title: "Ornaments", path: "/" },
  ...
  return (
    <header className="max-w-screen-2xl xl:px-28 px-4 absolute top-0 left-0 right-0">
      <nav className="flex justify-between items-center container md:py-4 pt-6 pb-3">
        ...
        <a href="/" className="">
          <img src={"public/images/category/images.png"} alt=""width={125}height={15} />
        </a>
